...
export default function EducationPublications() {
  return (
    <section id="education" className="scroll-mt-20 border-t border-hairline">
            ...
            <ul className="mt-10 space-y-5">
              {publications.map((pub, i) => (
                <Reveal as="li" key={pub} delay={i * 60}>
                  <div className="surface-card lift rounded-lg border border-hairline bg-surface px-5 py-4">
